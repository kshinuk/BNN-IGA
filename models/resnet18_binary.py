...
class ResNet_cifar10(ResNet):
    ...
    def __init__(self, num_classes=10, block=BasicBlock, depth=18, ao_bit=1, w_bit=1, adc_bit=1):
        ...
        self.layer1     = self._make_layer(block,  16*self.inflate, 2,
                                           ao_bit=ao_bit, w_bit=w_bit, adc_bit=adc_bit)
        self.layer2     = self._make_layer(block,  32*self.inflate, 2, stride=2,
                                           ao_bit=ao_bit, w_bit=w_bit, adc_bit=adc_bit)
        self.layer3     = self._make_layer(block,  64*self.inflate, 2, stride=2,
                                           ao_bit=ao_bit, w_bit=w_bit, adc_bit=adc_bit)
        self.layer4     = self._make_layer(block,  128*self.inflate, 2, stride=2, do_bntan=False,
                                           ao_bit=ao_bit, w_bit=w_bit, adc_bit=adc_bit)
        ...
        self.fc         = BinarizeLinear(128*self.inflate, 10,
...
def resnet18_binary(**kwargs):
    ...
    if dataset == 'imagenet':
        ...
        depth       = depth       or 18
        return ResNet_cifar10(num_classes=num_classes, block=Modified_BasicBlock, depth=depth, ao_bit=ao_bit, w_bit=w_bit, adc_bit=adc_bit)
