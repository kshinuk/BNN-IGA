...
class ResNet_cifar10(ResNet):
    ...
    def __init__(self, num_classes=10, block=BasicBlock, depth=20, ao_bit=1, w_bit=1, adc_bit=1):
        ...
        self.layer2     = self._make_layer(block,  32*self.inflate, 3, stride=2,
                                           ao_bit=ao_bit, w_bit=w_bit, adc_bit=adc_bit)
        self.layer3     = self._make_layer(block,  64*self.inflate, 3, stride=2, do_bntan=False,
                                           ao_bit=ao_bit, w_bit=w_bit, adc_bit=adc_bit)
